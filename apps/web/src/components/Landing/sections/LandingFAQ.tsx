...
export function LandingFAQ() {
	...
	const faqs = [
		...
		{
			question: `How does offline USSD voting (${ussdCode}) work?`,
			answer: `Anyone with any phone—smartphones or basic keypad phones—can dial ${ussdCode}, enter your event code, select their contestant, and confirm payment with their Mobile Money PIN. Votes tally in real time alongside online votes on your live dashboard.`,
		},
		{
		...
		{
			question: "Can attendees buy tickets or vote without having internet access?",
			answer:
				`Yes. Offline audiences can dial ${ussdCode} on any phone to cast votes and interact with events. Gate crew can also validate digital tickets quickly even in weak network environments.`,
		},
	];

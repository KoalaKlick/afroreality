...
const statusConfigs: Record<StatusVariant, StatusConfig> = {
    ...
    admin: {
        ...
        textColor: "text-gray-700 dark:text-gray-300",
        borderColor: "",
        bgColor: "bg-secondary-50 dark:bg-secondary-950/50",
        defaultText: "Admin",
    },
    member: {
        icon: User,
        ...
        textColor: "text-gray-700 dark:text-gray-300",
        borderColor: "",
        bgColor: "bg-tertiary-50 dark:bg-tertiary-950/50",
        defaultText: "Member",
    },
    ticketed: {
        icon: Ticket,
...
export function StatusBadge({
    ...
    return (
        <span
            className={cn(
                "inline-flex w-fit gap-1.5 items-center rounded border font-medium transition-colors bg-background",
                config.textColor,
                config.borderColor,
                config.bgColor,

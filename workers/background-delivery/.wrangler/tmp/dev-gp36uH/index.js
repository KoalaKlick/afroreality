...
// .wrangler/tmp/bundle-ZzADMA/strip-cf-connecting-ip-header.js
    ...
    for (const message of batch.messages) {
      try {
        ...
        if (type === "PAYMENT_SUCCESS") {
          ...
          if (phone && env2.ARKESEL_API_KEY) {
            await fetch("https://sms.arkesel.com/api/v2/sms/send", {
              method: "POST",
              headers: {
                "api-key": env2.ARKESEL_API_KEY,
...
// .wrangler/tmp/bundle-ZzADMA/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ZzADMA/middleware-loader.entry.ts
